...
`JAX <https://github.com/google/jax>`_ and `Flax <https://github.com/google/flax>`_ libraries but has since been ported to
`PyTorch <https://github.com/pytorch/pytorch>`_. It is named after the Latin word for fish, as it was designed
